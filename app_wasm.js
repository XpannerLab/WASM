...
var ASM_CONSTS = {
  17971467: () => { on_websocket_open(); },  
 17971492: () => { on_websocket_closed(); }
};
...
var _MachPosnRelNEH = Module['_MachPosnRelNEH'] = makeInvalidEarlyAccess('_MachPosnRelNEH');
...
var _JntAngBodyYawRollPitch = Module['_JntAngBodyYawRollPitch'] = makeInvalidEarlyAccess('_JntAngBodyYawRollPitch');
...
var _ErrTrvlTargetNE = Module['_ErrTrvlTargetNE'] = makeInvalidEarlyAccess('_ErrTrvlTargetNE');
var _ErrSwTargetAngle = Module['_ErrSwTargetAngle'] = makeInvalidEarlyAccess('_ErrSwTargetAngle');
var _ErrPanelTargetNEH = Module['_ErrPanelTargetNEH'] = makeInvalidEarlyAccess('_ErrPanelTargetNEH');
var _ErrPanelTargetHeading = Module['_ErrPanelTargetHeading'] = makeInvalidEarlyAccess('_ErrPanelTargetHeading');
var _ErrPanelTargetTiltLong = Module['_ErrPanelTargetTiltLong'] = makeInvalidEarlyAccess('_ErrPanelTargetTiltLong');
var _ErrPanelTargetTiltLat = Module['_ErrPanelTargetTiltLat'] = makeInvalidEarlyAccess('_ErrPanelTargetTiltLat');
var _JntAngSwing = Module['_JntAngSwing'] = makeInvalidEarlyAccess('_JntAngSwing');
var _JntAngBoomSwing = Module['_JntAngBoomSwing'] = makeInvalidEarlyAccess('_JntAngBoomSwing');
var _JntAngBodyToBoom = Module['_JntAngBodyToBoom'] = makeInvalidEarlyAccess('_JntAngBodyToBoom');
var _JntAngBoomToBoom2 = Module['_JntAngBoomToBoom2'] = makeInvalidEarlyAccess('_JntAngBoomToBoom2');
var _JntAngBoom2ToArm = Module['_JntAngBoom2ToArm'] = makeInvalidEarlyAccess('_JntAngBoom2ToArm');
var _JntAngArmToBucket = Module['_JntAngArmToBucket'] = makeInvalidEarlyAccess('_JntAngArmToBucket');
...
var _set_panel_changed = Module['_set_panel_changed'] = makeInvalidEarlyAccess('_set_panel_changed');
...
var _set_color_panel_damaged = Module['_set_color_panel_damaged'] = makeInvalidEarlyAccess('_set_color_panel_damaged');
var _set_color_panel_target = Module['_set_color_panel_target'] = makeInvalidEarlyAccess('_set_color_panel_target');
var _set_color_panel_next = Module['_set_color_panel_next'] = makeInvalidEarlyAccess('_set_color_panel_next');
...
var _set_color_panel_grabbed = Module['_set_color_panel_grabbed'] = makeInvalidEarlyAccess('_set_color_panel_grabbed');
var _set_color_panel_outline_nearby = Module['_set_color_panel_outline_nearby'] = makeInvalidEarlyAccess('_set_color_panel_outline_nearby');
var _set_color_panel_outline_grabbed = Module['_set_color_panel_outline_grabbed'] = makeInvalidEarlyAccess('_set_color_panel_outline_grabbed');
var _set_color_error_arrow_outline = Module['_set_color_error_arrow_outline'] = makeInvalidEarlyAccess('_set_color_error_arrow_outline');
var _set_color_error_arrow_solid = Module['_set_color_error_arrow_solid'] = makeInvalidEarlyAccess('_set_color_error_arrow_solid');
var _set_color_boundary_circle = Module['_set_color_boundary_circle'] = makeInvalidEarlyAccess('_set_color_boundary_circle');
var _set_color_boundary_pie = Module['_set_color_boundary_pie'] = makeInvalidEarlyAccess('_set_color_boundary_pie');
var _set_color_view_partition = Module['_set_color_view_partition'] = makeInvalidEarlyAccess('_set_color_view_partition');
var _set_color_arrow_line = Module['_set_color_arrow_line'] = makeInvalidEarlyAccess('_set_color_arrow_line');
var _set_color_arrow_line_highlight = Module['_set_color_arrow_line_highlight'] = makeInvalidEarlyAccess('_set_color_arrow_line_highlight');
var _set_color_arrow_tri = Module['_set_color_arrow_tri'] = makeInvalidEarlyAccess('_set_color_arrow_tri');
var _set_color_arrow_tri_highlight = Module['_set_color_arrow_tri_highlight'] = makeInvalidEarlyAccess('_set_color_arrow_tri_highlight');
var _set_size_outline_error_arrow_pos = Module['_set_size_outline_error_arrow_pos'] = makeInvalidEarlyAccess('_set_size_outline_error_arrow_pos');
var _set_size_outline_error_arrow_rot = Module['_set_size_outline_error_arrow_rot'] = makeInvalidEarlyAccess('_set_size_outline_error_arrow_rot');
var _set_size_outline_panel_nearby = Module['_set_size_outline_panel_nearby'] = makeInvalidEarlyAccess('_set_size_outline_panel_nearby');
var _set_size_outline_panel_grabbed = Module['_set_size_outline_panel_grabbed'] = makeInvalidEarlyAccess('_set_size_outline_panel_grabbed');
var _set_radius_nearby_panel = Module['_set_radius_nearby_panel'] = makeInvalidEarlyAccess('_set_radius_nearby_panel');
var _set_radius_boundary_circle = Module['_set_radius_boundary_circle'] = makeInvalidEarlyAccess('_set_radius_boundary_circle');
var _set_arrow = Module['_set_arrow'] = makeInvalidEarlyAccess('_set_arrow');
var _set_antialiasing_enabled = Module['_set_antialiasing_enabled'] = makeInvalidEarlyAccess('_set_antialiasing_enabled');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['MachPosnRelNEH'] != 'undefined', 'missing Wasm export: MachPosnRelNEH');
  assert(typeof wasmExports['MachPosnRelNorthing'] != 'undefined', 'missing Wasm export: MachPosnRelNorthing');
  assert(typeof wasmExports['MachPosnRelEasting'] != 'undefined', 'missing Wasm export: MachPosnRelEasting');
  assert(typeof wasmExports['MachPosnRelHeight'] != 'undefined', 'missing Wasm export: MachPosnRelHeight');
  assert(typeof wasmExports['JntAngBodyYawRollPitch'] != 'undefined', 'missing Wasm export: JntAngBodyYawRollPitch');
  assert(typeof wasmExports['JntAngBodyYaw'] != 'undefined', 'missing Wasm export: JntAngBodyYaw');
  assert(typeof wasmExports['JntAngBodyRoll'] != 'undefined', 'missing Wasm export: JntAngBodyRoll');
  assert(typeof wasmExports['JntAngBodyPitch'] != 'undefined', 'missing Wasm export: JntAngBodyPitch');
  assert(typeof wasmExports['ErrTrvlTargetNE'] != 'undefined', 'missing Wasm export: ErrTrvlTargetNE');
  assert(typeof wasmExports['ErrSwTargetAngle'] != 'undefined', 'missing Wasm export: ErrSwTargetAngle');
  assert(typeof wasmExports['ErrPanelTargetNEH'] != 'undefined', 'missing Wasm export: ErrPanelTargetNEH');
  assert(typeof wasmExports['ErrPanelTargetHeading'] != 'undefined', 'missing Wasm export: ErrPanelTargetHeading');
  assert(typeof wasmExports['ErrPanelTargetTiltLong'] != 'undefined', 'missing Wasm export: ErrPanelTargetTiltLong');
  assert(typeof wasmExports['ErrPanelTargetTiltLat'] != 'undefined', 'missing Wasm export: ErrPanelTargetTiltLat');
  assert(typeof wasmExports['JntAngSwing'] != 'undefined', 'missing Wasm export: JntAngSwing');
  assert(typeof wasmExports['JntAngBoomSwing'] != 'undefined', 'missing Wasm export: JntAngBoomSwing');
  assert(typeof wasmExports['JntAngBodyToBoom'] != 'undefined', 'missing Wasm export: JntAngBodyToBoom');
  assert(typeof wasmExports['JntAngBoomToBoom2'] != 'undefined', 'missing Wasm export: JntAngBoomToBoom2');
  assert(typeof wasmExports['JntAngBoom2ToArm'] != 'undefined', 'missing Wasm export: JntAngBoom2ToArm');
  assert(typeof wasmExports['JntAngArmToBucket'] != 'undefined', 'missing Wasm export: JntAngArmToBucket');
  assert(typeof wasmExports['JntAngTilt'] != 'undefined', 'missing Wasm export: JntAngTilt');
  assert(typeof wasmExports['JntAngTrRot'] != 'undefined', 'missing Wasm export: JntAngTrRot');
  assert(typeof wasmExports['JngAngDozerBlade'] != 'undefined', 'missing Wasm export: JngAngDozerBlade');
  assert(typeof wasmExports['set_compass'] != 'undefined', 'missing Wasm export: set_compass');
  assert(typeof wasmExports['set_position_mode'] != 'undefined', 'missing Wasm export: set_position_mode');
  assert(typeof wasmExports['set_pick_mode'] != 'undefined', 'missing Wasm export: set_pick_mode');
  assert(typeof wasmExports['set_place_mode'] != 'undefined', 'missing Wasm export: set_place_mode');
  assert(typeof wasmExports['set_target_distance'] != 'undefined', 'missing Wasm export: set_target_distance');
  assert(typeof wasmExports['set_target_distance_threshold'] != 'undefined', 'missing Wasm export: set_target_distance_threshold');
  assert(typeof wasmExports['set_tiltrotator_enabled'] != 'undefined', 'missing Wasm export: set_tiltrotator_enabled');
  assert(typeof wasmExports['set_grab_enabled'] != 'undefined', 'missing Wasm export: set_grab_enabled');
  assert(typeof wasmExports['set_control_enabled'] != 'undefined', 'missing Wasm export: set_control_enabled');
  assert(typeof wasmExports['set_auto_reset_enabled'] != 'undefined', 'missing Wasm export: set_auto_reset_enabled');
  assert(typeof wasmExports['set_camera_perspective'] != 'undefined', 'missing Wasm export: set_camera_perspective');
  assert(typeof wasmExports['set_output_enabled'] != 'undefined', 'missing Wasm export: set_output_enabled');
  assert(typeof wasmExports['open_db'] != 'undefined', 'missing Wasm export: open_db');
  assert(typeof wasmExports['close_db_local'] != 'undefined', 'missing Wasm export: close_db_local');
  assert(typeof wasmExports['set_target_and_next_panel_id'] != 'undefined', 'missing Wasm export: set_target_and_next_panel_id');
  assert(typeof wasmExports['set_panel_changed'] != 'undefined', 'missing Wasm export: set_panel_changed');
  assert(typeof wasmExports['open_db_local'] != 'undefined', 'missing Wasm export: open_db_local');
  assert(typeof wasmExports['set_color_excavator'] != 'undefined', 'missing Wasm export: set_color_excavator');
  assert(typeof wasmExports['set_color_panel'] != 'undefined', 'missing Wasm export: set_color_panel');
  assert(typeof wasmExports['set_color_panel_installed'] != 'undefined', 'missing Wasm export: set_color_panel_installed');
  assert(typeof wasmExports['set_color_panel_damaged'] != 'undefined', 'missing Wasm export: set_color_panel_damaged');
  assert(typeof wasmExports['set_color_panel_target'] != 'undefined', 'missing Wasm export: set_color_panel_target');
  assert(typeof wasmExports['set_color_panel_next'] != 'undefined', 'missing Wasm export: set_color_panel_next');
  assert(typeof wasmExports['set_color_outline'] != 'undefined', 'missing Wasm export: set_color_outline');
  assert(typeof wasmExports['set_color_bg'] != 'undefined', 'missing Wasm export: set_color_bg');
  assert(typeof wasmExports['set_color_pile'] != 'undefined', 'missing Wasm export: set_color_pile');
  assert(typeof wasmExports['set_color_panel_grabbed'] != 'undefined', 'missing Wasm export: set_color_panel_grabbed');
  assert(typeof wasmExports['set_color_panel_outline_nearby'] != 'undefined', 'missing Wasm export: set_color_panel_outline_nearby');
  assert(typeof wasmExports['set_color_panel_outline_grabbed'] != 'undefined', 'missing Wasm export: set_color_panel_outline_grabbed');
  assert(typeof wasmExports['set_color_error_arrow_outline'] != 'undefined', 'missing Wasm export: set_color_error_arrow_outline');
  assert(typeof wasmExports['set_color_error_arrow_solid'] != 'undefined', 'missing Wasm export: set_color_error_arrow_solid');
  assert(typeof wasmExports['set_color_boundary_circle'] != 'undefined', 'missing Wasm export: set_color_boundary_circle');
  assert(typeof wasmExports['set_color_boundary_pie'] != 'undefined', 'missing Wasm export: set_color_boundary_pie');
  assert(typeof wasmExports['set_color_view_partition'] != 'undefined', 'missing Wasm export: set_color_view_partition');
  assert(typeof wasmExports['set_color_arrow_line'] != 'undefined', 'missing Wasm export: set_color_arrow_line');
  assert(typeof wasmExports['set_color_arrow_line_highlight'] != 'undefined', 'missing Wasm export: set_color_arrow_line_highlight');
  assert(typeof wasmExports['set_color_arrow_tri'] != 'undefined', 'missing Wasm export: set_color_arrow_tri');
  assert(typeof wasmExports['set_color_arrow_tri_highlight'] != 'undefined', 'missing Wasm export: set_color_arrow_tri_highlight');
  assert(typeof wasmExports['set_size_outline_error_arrow_pos'] != 'undefined', 'missing Wasm export: set_size_outline_error_arrow_pos');
  assert(typeof wasmExports['set_size_outline_error_arrow_rot'] != 'undefined', 'missing Wasm export: set_size_outline_error_arrow_rot');
  assert(typeof wasmExports['set_size_outline_panel_nearby'] != 'undefined', 'missing Wasm export: set_size_outline_panel_nearby');
  assert(typeof wasmExports['set_size_outline_panel_grabbed'] != 'undefined', 'missing Wasm export: set_size_outline_panel_grabbed');
  assert(typeof wasmExports['set_radius_nearby_panel'] != 'undefined', 'missing Wasm export: set_radius_nearby_panel');
  assert(typeof wasmExports['set_radius_boundary_circle'] != 'undefined', 'missing Wasm export: set_radius_boundary_circle');
  assert(typeof wasmExports['set_arrow'] != 'undefined', 'missing Wasm export: set_arrow');
  assert(typeof wasmExports['set_antialiasing_enabled'] != 'undefined', 'missing Wasm export: set_antialiasing_enabled');
  assert(typeof wasmExports['set_camera_target_z'] != 'undefined', 'missing Wasm export: set_camera_target_z');
  assert(typeof wasmExports['set_camera_fov'] != 'undefined', 'missing Wasm export: set_camera_fov');
  assert(typeof wasmExports['set_camera_near_z'] != 'undefined', 'missing Wasm export: set_camera_near_z');
  assert(typeof wasmExports['set_camera_far_z'] != 'undefined', 'missing Wasm export: set_camera_far_z');
  assert(typeof wasmExports['set_view_ratio'] != 'undefined', 'missing Wasm export: set_view_ratio');
  assert(typeof wasmExports['set_view_count'] != 'undefined', 'missing Wasm export: set_view_count');
  assert(typeof wasmExports['update_viewports'] != 'undefined', 'missing Wasm export: update_viewports');
  assert(typeof wasmExports['set_vtx_grid_unit_size'] != 'undefined', 'missing Wasm export: set_vtx_grid_unit_size');
  assert(typeof wasmExports['set_info_grid_unit_size'] != 'undefined', 'missing Wasm export: set_info_grid_unit_size');
  assert(typeof wasmExports['set_view_range'] != 'undefined', 'missing Wasm export: set_view_range');
  assert(typeof wasmExports['set_norm_threshold'] != 'undefined', 'missing Wasm export: set_norm_threshold');
  assert(typeof wasmExports['set_z_threshold'] != 'undefined', 'missing Wasm export: set_z_threshold');
  assert(typeof wasmExports['set_z_norm_threshold'] != 'undefined', 'missing Wasm export: set_z_norm_threshold');
  assert(typeof wasmExports['set_z_norm_threshold_scale'] != 'undefined', 'missing Wasm export: set_z_norm_threshold_scale');
  assert(typeof wasmExports['set_outline_w'] != 'undefined', 'missing Wasm export: set_outline_w');
  assert(typeof wasmExports['wasm_free'] != 'undefined', 'missing Wasm export: wasm_free');
  ...
  _MachPosnRelNEH = Module['_MachPosnRelNEH'] = createExportWrapper('MachPosnRelNEH', 3);
  _MachPosnRelNorthing = Module['_MachPosnRelNorthing'] = createExportWrapper('MachPosnRelNorthing', 1);
  _MachPosnRelEasting = Module['_MachPosnRelEasting'] = createExportWrapper('MachPosnRelEasting', 1);
  _MachPosnRelHeight = Module['_MachPosnRelHeight'] = createExportWrapper('MachPosnRelHeight', 1);
  _JntAngBodyYawRollPitch = Module['_JntAngBodyYawRollPitch'] = createExportWrapper('JntAngBodyYawRollPitch', 3);
  _JntAngBodyYaw = Module['_JntAngBodyYaw'] = createExportWrapper('JntAngBodyYaw', 1);
  _JntAngBodyRoll = Module['_JntAngBodyRoll'] = createExportWrapper('JntAngBodyRoll', 1);
  _JntAngBodyPitch = Module['_JntAngBodyPitch'] = createExportWrapper('JntAngBodyPitch', 1);
  _ErrTrvlTargetNE = Module['_ErrTrvlTargetNE'] = createExportWrapper('ErrTrvlTargetNE', 2);
  _ErrSwTargetAngle = Module['_ErrSwTargetAngle'] = createExportWrapper('ErrSwTargetAngle', 1);
  _ErrPanelTargetNEH = Module['_ErrPanelTargetNEH'] = createExportWrapper('ErrPanelTargetNEH', 3);
  _ErrPanelTargetHeading = Module['_ErrPanelTargetHeading'] = createExportWrapper('ErrPanelTargetHeading', 1);
  _ErrPanelTargetTiltLong = Module['_ErrPanelTargetTiltLong'] = createExportWrapper('ErrPanelTargetTiltLong', 1);
  _ErrPanelTargetTiltLat = Module['_ErrPanelTargetTiltLat'] = createExportWrapper('ErrPanelTargetTiltLat', 1);
  _JntAngSwing = Module['_JntAngSwing'] = createExportWrapper('JntAngSwing', 1);
  _JntAngBoomSwing = Module['_JntAngBoomSwing'] = createExportWrapper('JntAngBoomSwing', 1);
  _JntAngBodyToBoom = Module['_JntAngBodyToBoom'] = createExportWrapper('JntAngBodyToBoom', 1);
  _JntAngBoomToBoom2 = Module['_JntAngBoomToBoom2'] = createExportWrapper('JntAngBoomToBoom2', 1);
  _JntAngBoom2ToArm = Module['_JntAngBoom2ToArm'] = createExportWrapper('JntAngBoom2ToArm', 1);
  _JntAngArmToBucket = Module['_JntAngArmToBucket'] = createExportWrapper('JntAngArmToBucket', 1);
  _JntAngTilt = Module['_JntAngTilt'] = createExportWrapper('JntAngTilt', 1);
  _JntAngTrRot = Module['_JntAngTrRot'] = createExportWrapper('JntAngTrRot', 1);
  _JngAngDozerBlade = Module['_JngAngDozerBlade'] = createExportWrapper('JngAngDozerBlade', 1);
  _set_compass = Module['_set_compass'] = createExportWrapper('set_compass', 3);
  _set_position_mode = Module['_set_position_mode'] = createExportWrapper('set_position_mode', 1);
  _set_pick_mode = Module['_set_pick_mode'] = createExportWrapper('set_pick_mode', 0);
  _set_place_mode = Module['_set_place_mode'] = createExportWrapper('set_place_mode', 0);
  _set_target_distance = Module['_set_target_distance'] = createExportWrapper('set_target_distance', 1);
  _set_target_distance_threshold = Module['_set_target_distance_threshold'] = createExportWrapper('set_target_distance_threshold', 1);
  _set_tiltrotator_enabled = Module['_set_tiltrotator_enabled'] = createExportWrapper('set_tiltrotator_enabled', 1);
  _set_grab_enabled = Module['_set_grab_enabled'] = createExportWrapper('set_grab_enabled', 1);
  _set_control_enabled = Module['_set_control_enabled'] = createExportWrapper('set_control_enabled', 1);
  _set_auto_reset_enabled = Module['_set_auto_reset_enabled'] = createExportWrapper('set_auto_reset_enabled', 1);
  _set_camera_perspective = Module['_set_camera_perspective'] = createExportWrapper('set_camera_perspective', 1);
  _set_output_enabled = Module['_set_output_enabled'] = createExportWrapper('set_output_enabled', 1);
  _open_db = Module['_open_db'] = createExportWrapper('open_db', 1);
  _close_db_local = Module['_close_db_local'] = createExportWrapper('close_db_local', 0);
  _set_target_and_next_panel_id = Module['_set_target_and_next_panel_id'] = createExportWrapper('set_target_and_next_panel_id', 2);
  _set_panel_changed = Module['_set_panel_changed'] = createExportWrapper('set_panel_changed', 4);
  _open_db_local = Module['_open_db_local'] = createExportWrapper('open_db_local', 1);
  _set_color_excavator = Module['_set_color_excavator'] = createExportWrapper('set_color_excavator', 1);
  _set_color_panel = Module['_set_color_panel'] = createExportWrapper('set_color_panel', 1);
  _set_color_panel_installed = Module['_set_color_panel_installed'] = createExportWrapper('set_color_panel_installed', 1);
  _set_color_panel_damaged = Module['_set_color_panel_damaged'] = createExportWrapper('set_color_panel_damaged', 1);
  _set_color_panel_target = Module['_set_color_panel_target'] = createExportWrapper('set_color_panel_target', 1);
  _set_color_panel_next = Module['_set_color_panel_next'] = createExportWrapper('set_color_panel_next', 1);
  _set_color_outline = Module['_set_color_outline'] = createExportWrapper('set_color_outline', 1);
  _set_color_bg = Module['_set_color_bg'] = createExportWrapper('set_color_bg', 1);
  _set_color_pile = Module['_set_color_pile'] = createExportWrapper('set_color_pile', 1);
  _set_color_panel_grabbed = Module['_set_color_panel_grabbed'] = createExportWrapper('set_color_panel_grabbed', 1);
  _set_color_panel_outline_nearby = Module['_set_color_panel_outline_nearby'] = createExportWrapper('set_color_panel_outline_nearby', 1);
  _set_color_panel_outline_grabbed = Module['_set_color_panel_outline_grabbed'] = createExportWrapper('set_color_panel_outline_grabbed', 1);
  _set_color_error_arrow_outline = Module['_set_color_error_arrow_outline'] = createExportWrapper('set_color_error_arrow_outline', 1);
  _set_color_error_arrow_solid = Module['_set_color_error_arrow_solid'] = createExportWrapper('set_color_error_arrow_solid', 1);
  _set_color_boundary_circle = Module['_set_color_boundary_circle'] = createExportWrapper('set_color_boundary_circle', 1);
  _set_color_boundary_pie = Module['_set_color_boundary_pie'] = createExportWrapper('set_color_boundary_pie', 1);
  _set_color_view_partition = Module['_set_color_view_partition'] = createExportWrapper('set_color_view_partition', 1);
  _set_color_arrow_line = Module['_set_color_arrow_line'] = createExportWrapper('set_color_arrow_line', 1);
  _set_color_arrow_line_highlight = Module['_set_color_arrow_line_highlight'] = createExportWrapper('set_color_arrow_line_highlight', 1);
  _set_color_arrow_tri = Module['_set_color_arrow_tri'] = createExportWrapper('set_color_arrow_tri', 1);
  _set_color_arrow_tri_highlight = Module['_set_color_arrow_tri_highlight'] = createExportWrapper('set_color_arrow_tri_highlight', 1);
  _set_size_outline_error_arrow_pos = Module['_set_size_outline_error_arrow_pos'] = createExportWrapper('set_size_outline_error_arrow_pos', 1);
  _set_size_outline_error_arrow_rot = Module['_set_size_outline_error_arrow_rot'] = createExportWrapper('set_size_outline_error_arrow_rot', 1);
  _set_size_outline_panel_nearby = Module['_set_size_outline_panel_nearby'] = createExportWrapper('set_size_outline_panel_nearby', 1);
  _set_size_outline_panel_grabbed = Module['_set_size_outline_panel_grabbed'] = createExportWrapper('set_size_outline_panel_grabbed', 1);
  _set_radius_nearby_panel = Module['_set_radius_nearby_panel'] = createExportWrapper('set_radius_nearby_panel', 1);
  _set_radius_boundary_circle = Module['_set_radius_boundary_circle'] = createExportWrapper('set_radius_boundary_circle', 1);
  _set_arrow = Module['_set_arrow'] = createExportWrapper('set_arrow', 2);
  _set_antialiasing_enabled = Module['_set_antialiasing_enabled'] = createExportWrapper('set_antialiasing_enabled', 1);
  _set_camera_target_z = Module['_set_camera_target_z'] = createExportWrapper('set_camera_target_z', 1);
  _set_camera_fov = Module['_set_camera_fov'] = createExportWrapper('set_camera_fov', 1);
  _set_camera_near_z = Module['_set_camera_near_z'] = createExportWrapper('set_camera_near_z', 1);
  _set_camera_far_z = Module['_set_camera_far_z'] = createExportWrapper('set_camera_far_z', 1);
  _set_view_ratio = Module['_set_view_ratio'] = createExportWrapper('set_view_ratio', 1);
  _set_view_count = Module['_set_view_count'] = createExportWrapper('set_view_count', 1);
  _update_viewports = Module['_update_viewports'] = createExportWrapper('update_viewports', 0);
  _set_vtx_grid_unit_size = Module['_set_vtx_grid_unit_size'] = createExportWrapper('set_vtx_grid_unit_size', 1);
  _set_info_grid_unit_size = Module['_set_info_grid_unit_size'] = createExportWrapper('set_info_grid_unit_size', 1);
  _set_view_range = Module['_set_view_range'] = createExportWrapper('set_view_range', 1);
  _set_norm_threshold = Module['_set_norm_threshold'] = createExportWrapper('set_norm_threshold', 1);
  _set_z_threshold = Module['_set_z_threshold'] = createExportWrapper('set_z_threshold', 1);
  _set_z_norm_threshold = Module['_set_z_norm_threshold'] = createExportWrapper('set_z_norm_threshold', 1);
  _set_z_norm_threshold_scale = Module['_set_z_norm_threshold_scale'] = createExportWrapper('set_z_norm_threshold_scale', 1);
  _set_outline_w = Module['_set_outline_w'] = createExportWrapper('set_outline_w', 1);
  _wasm_free = Module['_wasm_free'] = createExportWrapper('wasm_free', 1);
